 ...
 * @ORM\Entity(repositoryClass="BookBundle\Repository\CommandeRepository")
 */
class Commande
{
    /**
    ...
    /**
     * @ORM\ManyToOne (targetEntity="UtilisateurBundle\Entity\Utilisateur" , inversedBy="commande")
