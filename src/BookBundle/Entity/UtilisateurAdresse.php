 ...
 * @ORM\Entity(repositoryClass="BookBundle\Repository\UtilisateurAdresseRepository")
 */
class UtilisateurAdresse
{
    ...
    /**
     * @ORM\ManyToOne (targetEntity="UtilisateurBundle\Entity\Utilisateur", inversedBy="adresses")
